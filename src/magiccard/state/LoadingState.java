...
import magiccard.CardGameStateManager;
...
public class LoadingState extends LoadingAppState {
    ...
    private CardGameStateManager gameStateManager;
    ...
    public void initialize(AppStateManager stateManager, Application app) {
        ...
        this.gameStateManager = (CardGameStateManager) this.app.getGameStateManager();
        ...
        this.stageManager = (CardGameStageManager) this.app.getStageManager();
        setEnabled(true);
